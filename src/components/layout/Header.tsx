    ...
    <header className="h-20 flex items-center justify-between px-8 relative z-50">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="hidden lg:flex items-center gap-8 px-6 py-2 glass-card rounded-full">
          ...
          <div className="flex items-center gap-2">
            <Shield size={14} className="text-orange-600/60" />
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          >
            ...
            <Bell size={20} className="text-slate-400 group-hover:text-orange-500 transition-colors" />
          ...
          <AnimatePresence>
            {showNotifications && (
              <motion.div 
                ...
                className="absolute right-0 mt-4 w-80 glass-card p-4 overflow-hidden z-50"
              >
                <h3 className="text-[10px] font-bold text-orange-500 uppercase tracking-[0.3em] mb-4">Urgent Alerts</h3>
                <div className="space-y-3">
                  <div className="p-3 bg-white/5 rounded-lg border border-white/5 hover:border-orange-500/30 transition-colors group cursor-pointer">
